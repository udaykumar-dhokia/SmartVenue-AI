...
export interface MatchEvent {
  id: string;
  time: string;
  type: "wicket" | "boundary" | "six" | "over" | "drinks" | "innings" | "timeout";
  description: string;
}
...
export const VENUE_ZONES: VenueZone[] = [
  ...
  },
  {
    ...
    category: "Suite",
    tier: "suite",
    sections: ["301", "302", "303", "304", "305", "306", "307", "308", "309", "310", "311", "312", "313", "314", "315", "316", "317", "319", "320", "321", "322", "323", "324", "325", "326", "327", "328", "329", "330", "331", "332", "333", "334", "335"],
    capacity: 5000,
    currentOccupancy: 3500,
    density: 0.7,
    avgWaitTime: 3,
  ...
  },
  {
    ...
    category: "Suite",
    tier: "suite",
    sections: ["401", "402", "403", "404", "405", "406", "407", "408", "409", "410", "411", "412", "413", "414", "415", "416", "417", "418", "419", "420", "421", "422", "423", "424", "425", "426", "427", "428", "429", "430", "431", "432", "433", "434", "435", "436", "437", "438"],
    capacity: 5000,
    currentOccupancy: 4000,
    density: 0.8,
    avgWaitTime: 4,
...
export const CONCESSION_OUTLETS: ConcessionOutlet[] = [
  { id: "c1", name: "Dhokla Express", zone: "Stand A", waitTime: 12, itemsSold: 342, revenue: 68400, stockLevel: 0.6, popularItems: ["Dhokla", "Khandvi", "Fafda"] },
  { id: "c2", name: "Biryani Point", zone: "Stand B", waitTime: 8, itemsSold: 567, revenue: 141750, stockLevel: 0.4, popularItems: ["Chicken Biryani", "Veg Biryani", "Raita"] },
  { id: "c3", name: "Chaat Corner", zone: "Stand D", waitTime: 3, itemsSold: 234, revenue: 23400, stockLevel: 0.8, popularItems: ["Pani Puri", "Bhel", "Sev Puri"] },
  { id: "c4", name: "Pizza Hub", zone: "Stand G", waitTime: 6, itemsSold: 189, revenue: 56700, stockLevel: 0.7, popularItems: ["Margherita", "Pepperoni", "Garlic Bread"] },
  { id: "c5", name: "Cold Drinks Bar", zone: "Stand J", waitTime: 2, itemsSold: 890, revenue: 89000, stockLevel: 0.3, popularItems: ["Pepsi", "7Up", "Water"] },
  { id: "c6", name: "Ice Cream Parlor", zone: "Stand N", waitTime: 4, itemsSold: 456, revenue: 45600, stockLevel: 0.5, popularItems: ["Vanilla", "Mango", "Butterscotch"] },
  { id: "c7", name: "Samosa Junction", zone: "Pavilion Center", waitTime: 14, itemsSold: 678, revenue: 33900, stockLevel: 0.2, popularItems: ["Samosa", "Kachori", "Jalebi"] },
  { id: "c8", name: "South Indian Cafe", zone: "Stand P", waitTime: 5, itemsSold: 321, revenue: 48150, stockLevel: 0.6, popularItems: ["Dosa", "Idli", "Vada"] },
];
